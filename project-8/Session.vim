...
nmap <SNR>73_WE <Plug>AlignMapsWrapperEnd
map <SNR>73_WS <Plug>AlignMapsWrapperStart
...
set operatorfunc=<SNR>68_opfunc
set pastetoggle=<F5>
...
silent only
cd ~/documents/unix/project-8
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/documents/unix/final-exam/main.pl6
badd +24 ~/.vimrc
badd +1 ~/documents/unix/project-7/main.pl6
badd +0 ~/documents/unix/quiz-2/main.pl6
badd +0 ~/documents/unix/quiz-2/employee.pm
badd +0 ~/documents/unix/project-7/patient.pm
badd +1 ~/documents/unix/project-6/program.sh
badd +2 ~/documents/unix/project-6/data.csv
badd +0 main.pl
argglobal
silent! argdel *
set stal=2
edit ~/documents/unix/project-7/main.pl6
...
exe 'vert 1resize ' . ((&columns * 29 + 136) / 273)
...
setlocal foldtext=foldtext()
setlocal formatexpr=
setlocal formatoptions=n1jcrqol
setlocal formatlistpat=^\\s*\\d\\+[\\]:.)}\\t\ ]\\s*
setlocal grepprg=
setlocal iminsert=2
setlocal imsearch=2
...
setlocal indentkeys=0{,0},:,0#,!^F,o,O,e,0=,0),0],0>,0»,0=or,0=and
setlocal noinfercase
setlocal iskeyword=@,48-57,_,192-255,-
...
setlocal numberwidth=4
setlocal omnifunc=syntaxcomplete#Complete
setlocal path=.,/usr/include,,,Dynamic\ variable\ @*INC\ not\ found\
...
wincmd w
argglobal
edit ~/documents/unix/final-exam/main.pl6
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> î :call AutoPairsJump()a
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 168 - ((60 * winheight(0) + 31) / 63)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
168
...
exe 'vert 1resize ' . ((&columns * 31 + 136) / 273)
exe 'vert 2resize ' . ((&columns * 241 + 136) / 273)
tabedit ~/documents/unix/project-7/main.pl6
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 141 - ((21 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
141
...
wincmd w
argglobal
edit ~/documents/unix/project-7/patient.pm
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> î :call AutoPairsJump()a
...
wincmd w
argglobal
edit ~/documents/unix/quiz-2/main.pl6
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> î :call AutoPairsJump()a
...
wincmd w
argglobal
edit ~/documents/unix/quiz-2/employee.pm
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> î :call AutoPairsJump()a
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 147 - ((31 * winheight(0) + 32) / 64)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
147
