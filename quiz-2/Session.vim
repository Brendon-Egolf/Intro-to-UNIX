...
silent only
cd ~/documents/unix/quiz-2
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/documents/unix/project-7/main.pl6
badd +18 ~/documents/unix/project-7/patient.pm
badd +40 ~/.vimrc
badd +1 ~/documents/unix/project-7/4
badd +1 ~/documents/unix/project-7/patient-data.csv
badd +0 main.pl
argglobal
silent! argdel *
argadd ~/documents/unix/project-7/main.pl6
...
exe 'vert 1resize ' . ((&columns * 25 + 136) / 273)
exe '2resize ' . ((&lines * 32 + 33) / 66)
exe 'vert 2resize ' . ((&columns * 123 + 136) / 273)
