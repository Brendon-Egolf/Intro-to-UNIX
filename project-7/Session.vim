...
exe 'vert 1resize ' . ((&columns * 20 + 66) / 133)
exe '2resize ' . ((&lines * 31 + 32) / 65)
exe 'vert 2resize ' . ((&columns * 112 + 66) / 133)
exe '3resize ' . ((&lines * 31 + 32) / 65)
exe 'vert 3resize ' . ((&columns * 112 + 66) / 133)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
