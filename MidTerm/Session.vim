...
silent only
cd ~/documents/unix/midterm
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +15 EXAM.sh
badd +0 ~/.vim/UltiSnips/sh.snippets
badd +0 ~/documents/unix/project-5/program.sh
argglobal
silent! argdel *
argadd EXAM.sh
edit EXAM.sh
...
exe 'vert 3resize ' . ((&columns * 101 + 66) / 133)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 82 - ((27 * winheight(0) + 15) / 30)
...
wincmd w
argglobal
edit ~/documents/unix/project-5/program.sh
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> î :call AutoPairsJump()a
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 62 - ((15 * winheight(0) + 16) / 32)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
